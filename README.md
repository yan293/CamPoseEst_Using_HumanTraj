...
![Visualization of the real ground plane and the re-projected ground plane.  The blue dotted plane in each image represents the real position of the ground plane, while the pink dotted plane represents the ground plane projected with the camera pose predicted by our NN regressor.](experiments/result_visualization/ground_reprojection.png)
